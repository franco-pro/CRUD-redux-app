...
export const UpdateUserForm = () => {
  ...
  return (
    ...
    >
      ...
      <button className="flex justify-center text-md w-2/6 bg-yellow-400 text-white px-4 py-2 border rounded-md hover:bg-gray-50 hover:border-yellow-500 hover:text-green-500">
        Update{" "}
        <span className=" pl-1">
          <BiBrush size={15} />
        </span>
